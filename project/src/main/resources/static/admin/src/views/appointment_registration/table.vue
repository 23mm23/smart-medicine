<template>
	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/appointment_registration/table','set') || $check_action('/appointment_registration/view','set') || $check_action('/appointment_registration/view','get') 
				...
				<template slot-scope="scope">
					...
					v-if="$check_action('/appointment_registration/table','set') || $check_action('/appointment_registration/view','set') || $check_action('/appointment_registration/view','get')"
						...
						<!--跨表按钮-->
										<el-button class="e-button el-button--small is-plain el-button--primary" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/prescription_information/view')" v-if="($check_action('/prescription_information/table','add') || $check_action('/prescription_information/view','add')) && !scope.row['prescription_information_limit']">
						<span>开药</span>
					</el-button>
													<el-button class="e-button el-button--small is-plain el-button--primary" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/admission_information/view')" v-if="($check_action('/admission_information/table','add') || $check_action('/admission_information/view','add')) && !scope.row['admission_information_limit']">
						<span>入院</span>
					</el-button>
										</div>
				</template>
