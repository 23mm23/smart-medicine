<template>
	<div class="diy_details_box diy_div_drug_information">
			...
			<div class="container">
				...
				<div class="row row_det">
						<div v-if="this.$store.state.user.user_id" class="btns_add col-12 col-sm-6">
							<div v-if="$check_action('/drug_information/details','set')">
								<!-- 收藏按钮 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        ...
        var drug_information_id = this.obj.drug_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "drug_information",
          source_field: "drug_information_id",
          source_id: drug_information_id
        }, (res) => {
