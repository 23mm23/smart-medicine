	...
	<div class="diy_home diy_list diy_ordinary_user" id="diy_ordinary_user_list">
		...
		<div class="diy_view_table">
			<table class="diy_table">
				<tr class="diy_row">
							<th class="diy_title" v-if="$check_field('get','user_name','/ordinary_user/list')">
					用户姓名
				</th>
										<th class="diy_title" v-if="$check_field('get','user_gender','/ordinary_user/list')">
					用户性别
				</th>
										<th class="diy_title" v-if="$check_field('get','user_age','/ordinary_user/list')">
					用户年龄
				</th>
							</tr>
								<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
												<td class="diy_field diy_text" v-if="$check_field('get','user_name','/ordinary_user/list')">
						<span>
							{{ o["user_name"] }}
						</span>
					</td>
											<td class="diy_field diy_text" v-if="$check_field('get','user_gender','/ordinary_user/list')">
						<span>
							{{ o["user_gender"] }}
						</span>
					</td>
											<td class="diy_field diy_text" v-if="$check_field('get','user_age','/ordinary_user/list')">
						<span>
							{{ o["user_age"] }}
						</span>
					</td>
