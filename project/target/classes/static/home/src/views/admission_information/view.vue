				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_admission_information v-if="$check_action('/admission_information/view','get')"></view_admission_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_admission_information from "../../components/diy/view_admission_information.vue";
	export default {
		data() {
			return {
			};
