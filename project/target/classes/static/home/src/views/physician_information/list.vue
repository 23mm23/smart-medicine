<template>
	<div class="diy_list page_physician_information" id="physician_information_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">医师信息列表</span>
					</div>
				</div>
				<div class="leis_box"> 
				<div class="iudis_box">
					...
					<div class="col">
						...
						<div class="view Search">
							<span class="diy_list_search_title">关键字搜索：</span>
																																												<b-form-input size="sm" class="mr-sm-2" placeholder="医师姓名搜索" v-model="query['doctors_name']" />
																																																																								<b-form-input size="sm" class="mr-sm-2" placeholder="擅长领域搜索" v-model="query['specializes_in_specific_fields']" />
				...
				<div class="row diy_list_box">
					<div class="col">
						<!-- 列表 -->
												<list_physician_information :list="list" />
												<!-- /列表 -->
					</div>
				</div>
	</div>
...
<script>
	...
	export default {
      ...
      get_list_before(param) {
			 ...
			 */
			reset() {
								this.query.doctors_name = ""
												this.query.specializes_in_specific_fields = ""
									this.search();
			},
