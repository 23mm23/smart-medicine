				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_physician_user v-if="$check_action('/physician_user/view','get')"></view_physician_user>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_physician_user from "../../components/diy/view_physician_user.vue";
	export default {
		data() {
			return {
			};
