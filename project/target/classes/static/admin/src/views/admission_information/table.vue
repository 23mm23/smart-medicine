	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="$check_action('/admission_information/table','del') || $check_action('/admission_information/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
				...
				<el-table-column prop="physician_user" @sort-change="$sortChange" label="医师用户" 				v-if="$check_field('get','physician_user')" min-width="200">
					...
					<el-table-column prop="admission_time" @sort-change="$sortChange" label="入院时间" 				v-if="$check_field('get','admission_time')" min-width="200">
		                <template slot-scope="scope">
                	{{ $toTime(scope.row["admission_time"],"yyyy-MM-dd") }}
                </template>
					</el-table-column>
					<el-table-column prop="reason_for_admission" @sort-change="$sortChange" label="入院原因" 				v-if="$check_field('get','reason_for_admission')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/admission_information/table','set') || $check_action('/admission_information/view','set') || $check_action('/admission_information/view','get') 
						" >
				...
				<template slot-scope="scope">
					...
					v-if="$check_action('/admission_information/table','set') || $check_action('/admission_information/view','set') || $check_action('/admission_information/view','get')"
